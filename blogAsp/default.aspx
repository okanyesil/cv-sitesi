<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="blogAsp._default" %>
...
<body id="page-top">
    ...
    <div class="container-fluid p-0">
                    ...
                    <div class="my-auto">
                        <h1 class="mb-0">
                            ...
                            <span class="text-primary">
                                <asp:Label ID="lbl_soyad" runat="server" Text='<%# Eval("SOYAD") %>'></asp:Label></span>
                        </h1>
                        <div class="subheading mb-5">
                            <asp:Label ID="lbl_adress" runat="server" Text='<%# Eval("ADRESS") %>'></asp:Label>
                            <asp:Label ID="lbl_telefon" runat="server" Text='<%# Eval("TELEFON") %>'></asp:Label>
                            <a href="mailto:name@email.com">
                                <asp:Label ID="lbl_mail" runat="server" Text='<%# Eval("MAIL") %>'></asp:Label></a>
                        </div>
                        <p class="lead mb-5">
                            <asp:Label ID="lbl_hakkimda" runat="server" Text='<%# Eval("KISANOT") %>'></asp:Label><div class="social-icons">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                <h3 class="mb-0">
                                    <asp:Label ID="lbl_baslik" runat="server" Text='<%# Eval("BASLIK") %>'></asp:Label></h3>
                                <div class="subheading mb-3">
                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("ALT_BASLIK") %>'></asp:Label>
                                </div>
                                <p>
                            ...
                            <div class="resume-date text-md-right">
                                <span class="text-primary">
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("TARIH") %>'></asp:Label></span>
                            </div>
                        </div>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
            <div class="my-auto">
                <h2 class="mb-5">Eğitim Hayatı</h2>
                ...
                <div class="resume-item d-flex flex-column flex-md-row mb-5">
                    <div class="resume-content mr-auto">
                        <h3 class="mb-0">
                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("BASLIK") %>'></asp:Label></h3>
                        <div class="subheading mb-3">
                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("ALT_BASLIK") %>'></asp:Label></div>
                        <div>
                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("ACIKLAMA") %>'></asp:Label></div>
                        <p>
                            <asp:Label ID="Label7" runat="server" Text='<%# Eval("GNOT") %>'></asp:Label></p>
                    </div>
                    <div class="resume-date text-md-right">
                        <span class="text-primary">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="interests">
            ...
            <asp:Repeater ID="Repeater4" runat="server">
                     <ItemTemplate>
            <div class="my-auto">
                <asp:Label ID="Label9" runat="server" Text='<%# Eval("HOBİ") %>'></asp:Label>     
            </div>
           </ItemTemplate>
                 </asp:Repeater>
        </section>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="awards">
            <h2 class="mb-5">Kurslarım ve Ödüllerim</h2>
            ...
            <div class="my-auto"> 
                <ul class="fa-ul mb-0">
                    <li>
                        ...
                        <asp:Label ID="Label10" runat="server" Text='<%#Eval("ODULLER") %>'></asp:Label></li>
                </ul>
            </div>
                 </ItemTemplate>
            </asp:Repeater>
